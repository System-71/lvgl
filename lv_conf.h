...
#define LV_ASSERT_HANDLER printf("halted on assert");   /*Halt by default*/
...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(inter_bold600) LV_FONT_DECLARE(inter_bold600_36) LV_FONT_DECLARE(inter_boldblack_14) LV_FONT_DECLARE(inter_bold_700_slant_40px)
...
#define LV_USE_FS_STDIO 1
    ...
    #define LV_FS_STDIO_PATH "/media/maps/tiles/"         /*Set the working directory. File/directory paths will be appended to it.*/
